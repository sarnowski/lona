...
Write everything from device drivers to high-level applications in one unified, expressive language. See the [Lonala Language Specification](docs/lonala/index.md) for the complete reference.
...
See the [Installation Guide](docs/installation.md) to get Lona running on your development machine.
...
- [Testing Strategy](docs/development/testing-strategy.md) — The three-tier testing pyramid
- [Lonala Coding Guidelines](docs/development/lonala-coding-guidelines.md) — Standards for Lonala code
- [Rust Coding Guidelines](docs/development/rust-coding-guidelines.md) — Standards for Rust code
