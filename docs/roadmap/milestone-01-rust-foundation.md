...
**Deliverable**: A fully functional VM with processes, GC, domains, and all native primitives.
...
#### Task 1.10.7: Debugger Integration

**Description**: Interactive restart selection from REPL/debugger.

**Files to create**:
- `lona/debugger.lona`

**Requirements**:
- When unhandled condition reaches REPL, show options
- Display condition type and data
- List available restarts with descriptions
- User can inspect stack, locals
- User can choose restart interactively

**Tests**:
- Unhandled condition shows debugger
- Restarts listed
- User can select restart
- Inspection works
