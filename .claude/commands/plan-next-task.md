...
Then call Gemini (CLI) to create a plan (don’t give Gemini your plan). Ask Gemini to also do all the background research necessary (such as reading our docs and code as well as doing Internet research) and receive a plan back from it. Think about its plan and compare it with yours. Challenge your own plan with Gemini’s plan and think about the learnings that you can derive from it. Then review your own plan and check how to improve it in order to achieve optimal results.
