...
// =============================================================================
// Metadata Native Function Registration
// =============================================================================
...
/// - As a `NativeFunction` value in globals (for first-class use)
#[inline]
pub fn register_metadata_primitives(vm: &mut super::interpreter::Vm<'_>, symbols: &[symbol::Id]) {
...
// =============================================================================
// Built-in Native Functions for Metadata
// =============================================================================
